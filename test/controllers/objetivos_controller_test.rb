...
class ObjetivosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objetivo" do
    assert_difference('Objetivo.count') do
      post objetivos_url, params: { objetivo: { asignatura_id: @objetivo.asignatura_id, objetivo: @objetivo.objetivo } }
    end
  ...
  test "should update objetivo" do
    patch objetivo_url(@objetivo), params: { objetivo: { asignatura_id: @objetivo.asignatura_id, objetivo: @objetivo.objetivo } }
